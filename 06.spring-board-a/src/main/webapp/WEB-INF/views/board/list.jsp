              ...
              <div class="">
                ...
                <div class="row">
					<div class="col-sm-12 col-md-6">
						<div class="dataTables_length" id="dataTable_length" style="magin-bottom:5px">
							<form action="list.action" method="get">
								<select name="searchType" aria-controls="dataTable" class="form-control-sm">
									<option value="T">${ param.serachType == 'T' ? 'selected' : '' }제목</option>
									<option value="C">${ param.serachType == 'C' ? 'selected' : '' }내용</option>
									<option value="TC">${ param.serachType == 'TC' ? 'selected' : '' }제목+내용</option>
									<option value="W">${ param.serachType == 'W' ? 'selected' : '' }작성자</option>
									<!--  selected : 셀렉티드 된 옵션은 화면상에서 옵션중 먼저 선택돰 -->
								</select>
